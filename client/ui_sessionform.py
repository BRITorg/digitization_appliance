...
class Ui_SessionForm(object):
    def setupUi(self, SessionForm):
        ...
        self.stationCodeLabel = QtWidgets.QLabel(self.formLayoutWidget)
        self.stationCodeLabel.setObjectName("stationCodeLabel")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.stationCodeLabel)
        self.stationCodeLineEdit = QtWidgets.QLineEdit(self.formLayoutWidget)
        self.stationCodeLineEdit.setStatusTip("")
        self.stationCodeLineEdit.setObjectName("stationCodeLineEdit")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.stationCodeLineEdit)
        self.taxaLabel = QtWidgets.QLabel(self.formLayoutWidget)
        self.taxaLabel.setObjectName("taxaLabel")
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.taxaLabel)
        ...
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.taxaLineEdit)
        self.notesLabel = QtWidgets.QLabel(self.formLayoutWidget)
        self.notesLabel.setObjectName("notesLabel")
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.LabelRole, self.notesLabel)
        self.plainTextNotes = QtWidgets.QPlainTextEdit(self.formLayoutWidget)
        self.plainTextNotes.setObjectName("plainTextNotes")
        self.formLayout.setWidget(5, QtWidgets.QFormLayout.FieldRole, self.plainTextNotes)
    ...
    def retranslateUi(self, SessionForm):
        ...
        self.stationCodeLabel.setText(_translate("SessionForm", "Station Code"))
